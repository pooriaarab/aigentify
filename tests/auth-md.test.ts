...
describe('auth-md generator', () => {
  ...
  it('renders an agent signup call when signupUrl is set', () => {
    const md = generate('auth-md', { name: 'Acme', repository: 'https://github.com/acme/acme', signupUrl: 'https://acme.com/api/v1/agent/signup', apiBaseUrl: 'https://acme.com/api/public/v1' });
